...
export default function Filtro() {
 ...
 <FormLabel id="demo-radio-buttons-group-label">Relatório</FormLabel>
  <RadioGroup
    aria-labelledby="demo-radio-buttons-group-label"
    defaultValue="female"
    name="radio-buttons-group"
  >
    <FormControlLabel value="1" control={<Radio />} label="RI" />
    <FormControlLabel value="2" control={<Radio />} label="RNC" />
    <FormControlLabel value="3" control={<Radio />} label="RR" />
  </RadioGroup>
